 ...
 */
public class InsideScopeTargetSelector implements TargetSelector {
    ...
    public InsideScopeTargetSelector(final DistanceType distanceType) {
        this(DEFAULT_NOT_INCLUDING_SELF, distanceType);
    }

    public InsideScopeTargetSelector(final boolean includingSelf, final DistanceType distanceType) {
        this(1, includingSelf, distanceType);
    }

    public InsideScopeTargetSelector(final int maxCount, final DistanceType distanceType) {
        this(maxCount, DEFAULT_NOT_INCLUDING_SELF, distanceType);
    }

    public InsideScopeTargetSelector(final int maxCount, final boolean includingSelf, final DistanceType distanceType) {
        super();
